...
- Para evitar las excepciones por interrupción del flujo automático, no llenar el campo de **mensaje a transmitir** y el de **frames** desde el inicio de la ejecución. (de esta forma se puede continuar de forma manual durante toda la ejecución).
